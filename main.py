...
def main(image_path_png, image_path_jpg, iterations=50):
    ...
    tesserocr_png_time = measure_execution_time(infer_tesserocr, image_path_png, iterations, target_format="png")
    ...
    tesserocr_jpg_time = measure_execution_time(infer_tesserocr, image_path_jpg, iterations, target_format="jpg")
    ...
    jpg_times = [easyocr_jpg_time, fast_jpg_time, pytesseract_jpg_time, doctr_jpg_time, tesserocr_jpg_time]
...
if __name__ == "__main__":
    main(r"images\1695573507847.png", r"images\1695573507847.jpg")
