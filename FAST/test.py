...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', help='config file path',
                        default="config/fast/tt/fast_base_tt_800_finetune_ic17mlt.py", type=str)
    parser.add_argument('--checkpoint', nargs='?',
                        default="pretrained/fast_base_tt_800_finetune_ic17mlt.pth", type=str)
    ...
    parser.add_argument('--ema', action='store_true', default=True, required=False)
